    ...
    return (
        <div className="w-full flex flex-col gap-5 p-4">
            <div className="flex lg:items-center justify-between w-full flex-col sm:flex-row gap-3">
                ...
                <BtnOutline text="Create Quiz" css="bg-primary text-white" handleClick={handleClick} />
            </div>
                            ...
                            loading ? <tr>
                                ...
                                paginatedQuizzes?.map((quiz, index) => (
                                    <tr key={quiz.sr} className="border-b border-b-[#999999]">
                                        ...
                                        <td className="p-3 text-xl font-normal ">{quiz?.avg_rating.toFixed(2)}</td>
                                        <td className="p-3 text-xl font-normal ">
                                            <label className="switch">
                                                <input type="checkbox" checked={quiz?.is_available}
                                        ...
                                        <td className="p-3 text-xl font-normal  flex space-x-3">
                                            ...
                                            <RiDeleteBin6Fill className="size-6 cursor-pointer" onClick={() => handleDelete(quiz)} />
                                        </td>
                                    </tr>
                                ))}
                    </tbody>
