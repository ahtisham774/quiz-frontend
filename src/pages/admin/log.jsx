        ...
        if (id && logs?.length > 0) {
            ...
            if (selectedLog) {
                const log = {
                    ...
                    username: selectedLog?.studentId?.firstName + ' ' + selectedLog?.studentId?.lastName,
        ...
        <div className="w-full flex flex-col gap-5 p-4">
            <div className="flex items-center justify-between w-full flex-col sm:flex-row gap-3">
                ...
                <div className="flex flex-col gap-3">
                    <p className="text-lg text-[#999999] capitalize">Attempted by: {log?.username}</p>
                    <p className="text-lg text-[#999999]">Date:  {new Date(log?.dated).toLocaleDateString("en-US", {
                        hour: "numeric",
                        minute: "numeric",
                        second: "numeric",
                        year: "numeric",
            ...
            {log &&
                <>
                    ...
                    <div className="flex justify-start gap-5 mt-4">
                        ...
                        >
                            {
                                currentQuestionIndex === log?.questions?.length - 1 ? "Finish" : "Next"
                            }
                        </button>
