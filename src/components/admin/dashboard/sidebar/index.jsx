...
const menuGroups = [
    ...
    {
        icon: <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.5 18.75C17.8542 18.75 18.1617 18.62 18.4225 18.36C18.6833 18.1 18.8133 17.7925 18.8125 17.4375C18.8117 17.0825 18.6817 16.7754 18.4225 16.5163C18.1633 16.2571 17.8558 16.1267 17.5 16.125C17.1442 16.1233 16.8371 16.2538 16.5787 16.5163C16.3204 16.7788 16.19 17.0858 16.1875 17.4375C16.185 17.7892 16.3154 18.0967 16.5787 18.36C16.8421 18.6233 17.1492 18.7533 17.5 18.75ZM16.5625 14.75H18.4375C18.4375 14.1458 18.5 13.7033 18.625 13.4225C18.75 13.1417 19.0417 12.7717 19.5 12.3125C20.125 11.6875 20.5417 11.1825 20.75 10.7975C20.9583 10.4125 21.0625 9.95917 21.0625 9.4375C21.0625 8.5 20.7342 7.73458 20.0775 7.14125C19.4208 6.54792 18.5617 6.25083 17.5 6.25C16.6458 6.25 15.9013 6.48958 15.2663 6.96875C14.6313 7.44792 14.1883 8.08333 13.9375 8.875L15.625 9.5625C15.8125 9.04167 16.0679 8.65125 16.3912 8.39125C16.7146 8.13125 17.0842 8.00083 17.5 8C18 8 18.4062 8.14083 18.7188 8.4225C19.0312 8.70417 19.1875 9.08417 19.1875 9.5625C19.1875 9.85417 19.1042 10.1304 18.9375 10.3912C18.7708 10.6521 18.4792 10.98 18.0625 11.375C17.375 11.9792 16.9533 12.4533 16.7975 12.7975C16.6417 13.1417 16.5633 13.7925 16.5625 14.75ZM10 22.5C9.3125 22.5 8.72417 22.2554 8.235 21.7663C7.74583 21.2771 7.50083 20.6883 7.5 20V5C7.5 4.3125 7.745 3.72417 8.235 3.235C8.725 2.74583 9.31333 2.50083 10 2.5H25C25.6875 2.5 26.2763 2.745 26.7663 3.235C27.2563 3.725 27.5008 4.31333 27.5 5V20C27.5 20.6875 27.2554 21.2763 26.7663 21.7663C26.2771 22.2563 25.6883 22.5008 25 22.5H10ZM5 27.5C4.3125 27.5 3.72417 27.2554 3.235 26.7663C2.74583 26.2771 2.50083 25.6883 2.5 25V7.5H5V25H22.5V27.5H5Z" fill="#FFCC2C" />
        </svg>
        ,
        name: "Quizzes",
        route: "quizzes",
    ...
    {
        icon: <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.875 0V18.75C1.875 24.9628 6.91219 30 13.125 30H14.0625V11.25C14.0625 5.03625 9.02531 0 2.8125 0H1.875ZM16.875 18.75V30H27.1875V18.75H16.875Z" fill="#FFCC2C" />
        </svg>
        ,
        name: "Logs",
        route: "logs",
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <ClickOutside onClick={() => setSidebarOpen(false)}>
            <aside
                className={`fixed left-0 top-0 z-20 lg:z-10 flex h-full w-60 p-4 flex-col items-center overflow-y-hidden bg-[#fff] drop-shadow-md duration-300 ease-linear  lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
                {/* <!-- SIDEBAR HEADER --> */}
